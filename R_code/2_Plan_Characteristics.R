...
## Raw 2007 data
ma.path.2007=paste0(path.data.ma,"/ma-plan-characteristics/2007 MA Landscape Source File 11-16-06.csv")
...
macd.path.2015b=paste0(path.data.ma,"/ma-plan-characteristics/PartCD/2015/Medicare Part D 2015 Plan Report 03182015.xls")
...
write_rds(plan.premiums,"plan_premiums.rds")
