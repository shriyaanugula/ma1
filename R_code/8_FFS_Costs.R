...
ffs.path.2007=paste0(path.data.ffs,"/ffs-costs/Aged Only/Aged07.csv")
ffs.path.2008=paste0(path.data.ffs,"/ffs-costs/Aged Only/AGED08.csv")
ffs.path.2009=paste0(path.data.ffs,"/ffs-costs/Aged Only/aged09.csv")
ffs.path.2010=paste0(path.data.ffs,"/ffs-costs/Aged Only/aged10.csv")
ffs.path.2011=paste0(path.data.ffs,"/ffs-costs/Aged Only/aged11.csv")
ffs.path.2012=paste0(path.data.ffs,"/ffs-costs/Aged Only/aged12.csv")
ffs.path.2013=paste0(path.data.ffs,"/ffs-costs/Aged Only/aged13.csv")
ffs.path.2014=paste0(path.data.ffs,"/ffs-costs/Aged Only/aged14.csv")
ffs.path.2015=paste0(path.data.ffs,"/ffs-costs/FFS15.xlsx")
...
write_rds(ffs.costs.final,"ffs_costs.rds")